            ...
            <nav className="border-gray-200 px-2 sm:px-4 py-2.5 rounded">
                <div className="container flex flex-wrap items-center justify-between mx-auto">
                    ...
                    <div className="items-center justify-between hiddsen w-full md:flex md:w-auto order-1 md:order-1" hidden={hiddenNav} id="mobile-menu-2">
                        <ul className="items-center flex flex-col w-full p-4 mt-4 border items-centers border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 dark:border-gray-700">
